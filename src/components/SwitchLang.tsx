  ...
  return (
    <div className="relative">
      <Menu>
        ...
        >
          <Menu.Items className="absolute top-0 right-0 z-20 mt-8 w-28 divide-y divide-gray-900 overflow-auto rounded-lg border border-gray-900/10 bg-white py-1 shadow-lg focus:outline-none dark:border-gray-500/30 dark:bg-black dark:text-white">
            {locales!.map(locale => (
              <Menu.Item key={locale}>
                ...
                >
                  <div className="m-1 cursor-pointer rounded-lg px-2 py-1 text-left text-sm font-medium hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-600/10 dark:hover:text-blue-400">
                    {localeText(locale)}
                  </div>
                </CustomLink>
              </Menu.Item>
