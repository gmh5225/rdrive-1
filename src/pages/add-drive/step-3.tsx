...
//   const [accountAlreadyConnected, setAlreadyConnected] = useState(false)
//   const [authPersonInfo, setAuthPersonInfo] = useState({ data: { userPrincipalName: '' }, status: -1 })

//   getAuthPersonInfo(accessToken)
//   .then(({data, status}) => {
//     setAuthPersonInfo({data, status});
